...
router.post('/save', (req, res, next) => {
  ...
  if (req.body.docreate === "create") {
    p = items.create(guid(),
      req.body.shortname, req.body.categoryid, req.body.maker, req.body.makerref, req.body.contactid, req.body.providerurl, req.body.lastpurchasedate, req.body.price, req.body.unit, req.body.width, req.body.height, req.body.diameter, req.body.picture, req.body.note, req.body.quantityinstock, req.body.stocklimitalert
    );
  } else {
